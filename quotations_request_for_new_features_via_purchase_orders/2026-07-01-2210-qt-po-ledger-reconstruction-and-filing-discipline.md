# QT-2026-07-01-2210 — PO Ledger Reconstruction and Filing Discipline

status: quotation request
document type: QT
quotation number: QT-2026-07-01-2210
...
QT means quotation. It is a pre-PO request asking for scope, structure, cost-of-change, discipline, or proposed purchase-order contents.

RFI means request for information. It is a pre-PO information request where the answer may later become a quotation or PO.

PO means accepted purchase order. Only accepted POs belong in build_ladder_purchase_orders.

This document is a QT. It may be answered by one or more later POs. It is not itself an accepted PO.
...
If this QT is accepted, it should become its own accepted PO file after acceptance, probably:
